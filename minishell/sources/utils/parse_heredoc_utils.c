...
/* fill_heredoc:
*	Copies user input into a temporary file. If user inputs env variable
*	like $USER, expands the variable before writing to the heredoc.
*	Returns true on success, false on failure.
*	Friendly reminder, a heredoc take string that you write
*	until you write the "name" that you use; "cat << test" for example
*	and display them.
*/
